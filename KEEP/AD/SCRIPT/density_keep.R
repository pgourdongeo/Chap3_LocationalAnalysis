...
rm(sfPointsCorr, sfPointsWater, sfPartPeriod, idvec)
...
dfPartPeriodCount <- sfPartPeriodSpe %>% 
...
partCntr <- ggplot(data = dfpartCntrUE, 
  ...
  labs(x = "UE28",
       y = "Nombre de participations sur la période 2000-2020") +
  theme_light() +
